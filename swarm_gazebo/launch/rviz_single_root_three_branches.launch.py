...
def generate_launch_description():
    ...
    #
    # This version splits internally inside the mock simulator.
    ...
    actions.append(Node(
        ...
        parameters=[
            ...
            # One shared root in the middle.
            {'root_x': 0.0},
            {'root_y': 0.0},

            # Compact startup layout around the root.
            ...
            {'max_branch_depth': 2},
            {'min_group_age_before_split_sec': 6.0},
        ],
    ))
